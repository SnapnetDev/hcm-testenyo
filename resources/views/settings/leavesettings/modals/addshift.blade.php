                ...
                <div class="row row-lg col-xs-12">            
                  <div class="col-xs-12"> 
                    ...
                    <div class="form-group">
                      ...
                      <select  class="form-control" name='shift_type_id' id="editshifttype">
                    ...
                    <input type="time" data-plugin="clockpicker" class="form-control" name="start_time" autocomplete="off">
                    ...
                    <input type="time" class=" clockpicker form-control" name="end_time" autocomplete="off">
                    <span class="input-group-addon">
                      <span class="md-time"></span>
                    </span>
                  </div>
