...
@section('content')
    ...
    <div class="page ">
        <div class="page-header">
            <h1 class="page-title">{{__('Staff Timesheet')}}</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                <li class="breadcrumb-item active">{{__('Staff Timesheet')}}</li>
            </ol>
        ...
        <div class="page-content container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form method="GET" action="{{route("staff.timesheet.excel")}}">
           ...
           {{-- <div class="col-md-12 col-xs-12 col-md-12">
                <div class="panel panel-info panel-line">
                    <div class="panel-heading">
                        <h3 class="panel-title">Staff Timesheet (Hours Worked)</h3>
